...
class Config(object):
    ...
    def __init__(self, dataset):
        self.model_name = 'roberta_chinese_large'
        ...
        self.tokenizer = BertTokenizer.from_pretrained(self.bert_path_3)
...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.bert = BertModel.from_pretrained(config.bert_path_3)
