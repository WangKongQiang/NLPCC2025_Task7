...
def submit(config, model):
    ...
    df.to_csv(r"./data/test_submit_bagging.csv", index=False)
...
if __name__ == '__main__':
    model_list = ["data/saved_dict/bert.ckpt", "data/saved_dict/ERNIE.ckpt",
                  "data/saved_dict/roberta-chinese.ckpt", "data/saved_dict/roberta_chinese_large.ckpt"]
    model_name =['bert',"ERNIE","roberta-chinese","roberta_chinese_large"]
    # dataset = 'data'
    config=Config('data')
